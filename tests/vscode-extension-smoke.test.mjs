...
assert.equal(manifest.contributes.viewsContainers.activitybar[0].id, 'archflow');
assert.equal(manifest.contributes.views.archflow[0].id, 'archflow.dashboard');
...
assert.match(host, /registerWebviewViewProvider/);
